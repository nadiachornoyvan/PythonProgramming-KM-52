...
line1=data[0]
(post_code, cost, country, city, street, build, app, dt) = line1
fline1=f"| {post_code:^11} | {cost:^21} | {country:^11} | {city:^12} | {street:^20} | {build:^8} | {app:^6} | {dt:^28} |"
print(fline1)

line2=f"| {"-"*11} + {"-"*21} + {"-"*11} + {"-"*12} + {"-"*20} + {"-"*8} + {"-"*6} + {"-"*28} | "
print(line2)

for line in data[1:]:
    (post_code, cost, country, city, street, build, app, dt)=line
    isostring=dt.isoformat()
    fline=(f"| {post_code:<11} | {cost/1000:>21.3f} | {country:<11} | {city:<12} | {street:<20} | {build:>8} | {app:>6} | {isostring:^28} |")
    print(fline)